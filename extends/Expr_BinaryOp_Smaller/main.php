...
// Less-than comparison of two integers where left is smaller
$left = 41;
$right = 42;
$result = $left < $right;
if ($result === true) {
...
// Less-than comparison of two integers where left is greater
$left = 43;
$right = 42;
$result = $left < $right;
if ($result === false) {
...
// Less-than comparison of two integers where both are equal
$left = 42;
$right = 42;
$result = $left < $right;
if ($result === false) {
...
// Less-than comparison of a string and an integer
$left = "100";
$right = 42;
$result = $left < $right;
if ($result === false) {
...
// Less-than comparison of two strings (lexicographical comparison)
$left = "apple";
$right = "banana";
$result = $left < $right;
if ($result === true) {
...
// Less-than comparison of a floating-point number and an integer
$left = 41.9;
$right = 42;
$result = $left < $right;
if ($result === true) {
...
// Less-than comparison of two floating-point numbers
$left = 42.4;
$right = 42.5;
$result = $left < $right;
if ($result === true) {
...
// Less-than comparison where left is a boolean and right is an integer
...
// Less-than comparison where both values are null
$left = null;
$right = null;
$result = $left < $right;
if ($result === false) {
...
// Less-than comparison of two arrays with different elements
$left = [1, 2, 3];
$right = [2, 3, 4];
$result = $left < $right;
if ($result === true) {
